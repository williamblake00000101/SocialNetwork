    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AppUserId = table.Column<int>(type: "int", nullable: false),
                    AppUserFriendId = table.Column<int>(type: "int", nullable: false),
                    IsConfirmed = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersFriends", x => new { x.AppUserId, x.AppUserFriendId });
                    table.ForeignKey(
                        name: "FK_UsersFriends_AspNetUsers_AppUserFriendId",
                        column: x => x.AppUserFriendId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UsersFriends_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersFriends_AppUserFriendId",
                table: "UsersFriends",
